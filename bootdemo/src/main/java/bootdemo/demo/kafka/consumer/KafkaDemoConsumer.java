package bootdemo.demo.kafka.consumer;
...
import bootdemo.demo.kafka.consumer.config.KafkaConfigConsumer;
import bootdemo.demo.kafka.consumer.queue.CollectQueue;
import bootdemo.demo.kafka.consumer.thread.KafkaToLocalThread;
